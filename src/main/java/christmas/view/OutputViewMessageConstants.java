...
public class OutputViewMessageConstants {
    ...
    public static final String TOTAL_AMOUNT_FORMAT = "%s원";
    ...
    public static final String MATCHING_EVENT_FORMAT = "%s: -%s원";
    public static final String TOTAL_BENEFIT_AMOUNT_TITLE = "<총혜택 금액>";
    public static final String NO_TOTAL_BENEFIT_AMOUNT_MESSAGE = "0원";
    public static final String TOTAL_BENEFIT_AMOUNT_FORMAT = "-%s원";
